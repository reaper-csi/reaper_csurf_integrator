...
public:
    ...
    virtual void DoAction(MediaTrack* track) { DoAction(1.0); } // GAW -- Total hack to ensure DoAction(1.0) gets called if generated by OnFocusedFX
    virtual void DoAction(MediaTrack* track, int fxIndex) { DoAction(1.0); } // GAW -- Total hack to ensure DoAction(1.0) gets called  if generated by OnTrackSelection
