...
public:
    ...
    virtual void Run() override
    {
        ...
        if(name_ == "LaunchPad")
        {
            ...
            midiSysExData.evt.midi_message[midiSysExData.evt.size++] = 0x03;
            midiSysExData.evt.midi_message[midiSysExData.evt.size++] = 0x53;
            midiSysExData.evt.midi_message[midiSysExData.evt.size++] = value;
            midiSysExData.evt.midi_message[midiSysExData.evt.size++] = 0x00;
            midiSysExData.evt.midi_message[midiSysExData.evt.size++] = 0x00;
            
            midiSysExData.evt.midi_message[midiSysExData.evt.size++] = 0x03;
            midiSysExData.evt.midi_message[midiSysExData.evt.size++] = 0x58;
            midiSysExData.evt.midi_message[midiSysExData.evt.size++] = 127 - value;
            midiSysExData.evt.midi_message[midiSysExData.evt.size++] = value;
            midiSysExData.evt.midi_message[midiSysExData.evt.size++] = value;
            
            midiSysExData.evt.midi_message[midiSysExData.evt.size++] = 0x03;
            midiSysExData.evt.midi_message[midiSysExData.evt.size++] = 0x54;
            midiSysExData.evt.midi_message[midiSysExData.evt.size++] = 0x00;
            midiSysExData.evt.midi_message[midiSysExData.evt.size++] = value;
            midiSysExData.evt.midi_message[midiSysExData.evt.size++] = 0x00;
            
            midiSysExData.evt.midi_message[midiSysExData.evt.size++] = 0x03;
            midiSysExData.evt.midi_message[midiSysExData.evt.size++] = 0x51;
            midiSysExData.evt.midi_message[midiSysExData.evt.size++] = value;
            midiSysExData.evt.midi_message[midiSysExData.evt.size++] = 127 - value;
            midiSysExData.evt.midi_message[midiSysExData.evt.size++] = value;
            
            midiSysExData.evt.midi_message[midiSysExData.evt.size++] = 0x03;
            midiSysExData.evt.midi_message[midiSysExData.evt.size++] = 0x57;
            midiSysExData.evt.midi_message[midiSysExData.evt.size++] = 0x00;
            midiSysExData.evt.midi_message[midiSysExData.evt.size++] = 0x00;
            midiSysExData.evt.midi_message[midiSysExData.evt.size++] = value;
            
            midiSysExData.evt.midi_message[midiSysExData.evt.size++] = 0x03;
            midiSysExData.evt.midi_message[midiSysExData.evt.size++] = 0x56;
            midiSysExData.evt.midi_message[midiSysExData.evt.size++] = value;
            midiSysExData.evt.midi_message[midiSysExData.evt.size++] = value;
            midiSysExData.evt.midi_message[midiSysExData.evt.size++] = 127 - value;
            
            midiSysExData.evt.midi_message[midiSysExData.evt.size++] = 0x03;
            midiSysExData.evt.midi_message[midiSysExData.evt.size++] = 0x52;
            midiSysExData.evt.midi_message[midiSysExData.evt.size++] = value;
            midiSysExData.evt.midi_message[midiSysExData.evt.size++] = value;
            midiSysExData.evt.midi_message[midiSysExData.evt.size++] = value;
            
            midiSysExData.evt.midi_message[midiSysExData.evt.size++] = 0x03;
            midiSysExData.evt.midi_message[midiSysExData.evt.size++] = 0x55;
            midiSysExData.evt.midi_message[midiSysExData.evt.size++] = 127 - value;
            midiSysExData.evt.midi_message[midiSysExData.evt.size++] = 127 - value;
            midiSysExData.evt.midi_message[midiSysExData.evt.size++] = 127 - value;
            ...
            midiSysExData.evt.midi_message[midiSysExData.evt.size++] = 0x03;
            midiSysExData.evt.midi_message[midiSysExData.evt.size++] = 0x4c;
            midiSysExData.evt.midi_message[midiSysExData.evt.size++] = 0x00;
            midiSysExData.evt.midi_message[midiSysExData.evt.size++] = value;
            midiSysExData.evt.midi_message[midiSysExData.evt.size++] = 0x00;
            
            midiSysExData.evt.midi_message[midiSysExData.evt.size++] = 0x03;
            midiSysExData.evt.midi_message[midiSysExData.evt.size++] = 0x4b;
            midiSysExData.evt.midi_message[midiSysExData.evt.size++] = value;
            midiSysExData.evt.midi_message[midiSysExData.evt.size++] = 127 - value;
            midiSysExData.evt.midi_message[midiSysExData.evt.size++] = value;
            ...
            midiSysExData.evt.midi_message[midiSysExData.evt.size++] = 0x03;
            midiSysExData.evt.midi_message[midiSysExData.evt.size++] = 0x49;
            midiSysExData.evt.midi_message[midiSysExData.evt.size++] = value;
            midiSysExData.evt.midi_message[midiSysExData.evt.size++] = value;
            midiSysExData.evt.midi_message[midiSysExData.evt.size++] = 127 - value;
            
            midiSysExData.evt.midi_message[midiSysExData.evt.size++] = 0x03;
            midiSysExData.evt.midi_message[midiSysExData.evt.size++] = 0x48;
            midiSysExData.evt.midi_message[midiSysExData.evt.size++] = value;
            midiSysExData.evt.midi_message[midiSysExData.evt.size++] = value;
            midiSysExData.evt.midi_message[midiSysExData.evt.size++] = value;
            
            midiSysExData.evt.midi_message[midiSysExData.evt.size++] = 0x03;
            midiSysExData.evt.midi_message[midiSysExData.evt.size++] = 0x47;
            midiSysExData.evt.midi_message[midiSysExData.evt.size++] = 127 - value;
            midiSysExData.evt.midi_message[midiSysExData.evt.size++] = 127 - value;
            midiSysExData.evt.midi_message[midiSysExData.evt.size++] = 127 - value;
            ...
            midiSysExData.evt.midi_message[midiSysExData.evt.size++] = 0x03;
            midiSysExData.evt.midi_message[midiSysExData.evt.size++] = 0x3d;
            midiSysExData.evt.midi_message[midiSysExData.evt.size++] = value;
            midiSysExData.evt.midi_message[midiSysExData.evt.size++] = 0x00;
            midiSysExData.evt.midi_message[midiSysExData.evt.size++] = 0x00;
            
            midiSysExData.evt.midi_message[midiSysExData.evt.size++] = 0x03;
            midiSysExData.evt.midi_message[midiSysExData.evt.size++] = 0x41;
            midiSysExData.evt.midi_message[midiSysExData.evt.size++] = 127 - value;
            midiSysExData.evt.midi_message[midiSysExData.evt.size++] = value;
            midiSysExData.evt.midi_message[midiSysExData.evt.size++] = value;
            
            midiSysExData.evt.midi_message[midiSysExData.evt.size++] = 0x03;
            midiSysExData.evt.midi_message[midiSysExData.evt.size++] = 0x42;
            midiSysExData.evt.midi_message[midiSysExData.evt.size++] = 0x00;
            midiSysExData.evt.midi_message[midiSysExData.evt.size++] = value;
            midiSysExData.evt.midi_message[midiSysExData.evt.size++] = 0x00;
            
            midiSysExData.evt.midi_message[midiSysExData.evt.size++] = 0x03;
            midiSysExData.evt.midi_message[midiSysExData.evt.size++] = 0x44;
            midiSysExData.evt.midi_message[midiSysExData.evt.size++] = value;
            midiSysExData.evt.midi_message[midiSysExData.evt.size++] = 127 - value;
            midiSysExData.evt.midi_message[midiSysExData.evt.size++] = value;
            
            midiSysExData.evt.midi_message[midiSysExData.evt.size++] = 0x03;
            midiSysExData.evt.midi_message[midiSysExData.evt.size++] = 0x3f;
            midiSysExData.evt.midi_message[midiSysExData.evt.size++] = 0x00;
            midiSysExData.evt.midi_message[midiSysExData.evt.size++] = 0x00;
            midiSysExData.evt.midi_message[midiSysExData.evt.size++] = value;
            ...
            midiSysExData.evt.midi_message[midiSysExData.evt.size++] = 0x03;
            midiSysExData.evt.midi_message[midiSysExData.evt.size++] = 0x40;
            midiSysExData.evt.midi_message[midiSysExData.evt.size++] = value;
            midiSysExData.evt.midi_message[midiSysExData.evt.size++] = value;
            midiSysExData.evt.midi_message[midiSysExData.evt.size++] = value;
            
            midiSysExData.evt.midi_message[midiSysExData.evt.size++] = 0x03;
            midiSysExData.evt.midi_message[midiSysExData.evt.size++] = 0x3e;
            midiSysExData.evt.midi_message[midiSysExData.evt.size++] = 127 - value;
            midiSysExData.evt.midi_message[midiSysExData.evt.size++] = 127 - value;
            midiSysExData.evt.midi_message[midiSysExData.evt.size++] = 127 - value;
            ...
            midiSysExData.evt.midi_message[midiSysExData.evt.size++] = 0x03;
            midiSysExData.evt.midi_message[midiSysExData.evt.size++] = 0x35;
            midiSysExData.evt.midi_message[midiSysExData.evt.size++] = value;
            midiSysExData.evt.midi_message[midiSysExData.evt.size++] = 0x00;
            midiSysExData.evt.midi_message[midiSysExData.evt.size++] = 0x00;
            
            midiSysExData.evt.midi_message[midiSysExData.evt.size++] = 0x03;
            midiSysExData.evt.midi_message[midiSysExData.evt.size++] = 0x37;
            midiSysExData.evt.midi_message[midiSysExData.evt.size++] = 127 - value;
            midiSysExData.evt.midi_message[midiSysExData.evt.size++] = value;
            midiSysExData.evt.midi_message[midiSysExData.evt.size++] = 127 - value;
            
            midiSysExData.evt.midi_message[midiSysExData.evt.size++] = 0x03;
            midiSysExData.evt.midi_message[midiSysExData.evt.size++] = 0x36;
            midiSysExData.evt.midi_message[midiSysExData.evt.size++] = 0x00;
            midiSysExData.evt.midi_message[midiSysExData.evt.size++] = value;
            midiSysExData.evt.midi_message[midiSysExData.evt.size++] = 0x00;
            ...
            midiSysExData.evt.midi_message[midiSysExData.evt.size++] = 0x03;
            midiSysExData.evt.midi_message[midiSysExData.evt.size++] = 0x33;
            midiSysExData.evt.midi_message[midiSysExData.evt.size++] = 0x00;
            midiSysExData.evt.midi_message[midiSysExData.evt.size++] = 0x00;
            midiSysExData.evt.midi_message[midiSysExData.evt.size++] = value;
            
            midiSysExData.evt.midi_message[midiSysExData.evt.size++] = 0x03;
            midiSysExData.evt.midi_message[midiSysExData.evt.size++] = 0x39;
            midiSysExData.evt.midi_message[midiSysExData.evt.size++] = value;
            midiSysExData.evt.midi_message[midiSysExData.evt.size++] = value;
            midiSysExData.evt.midi_message[midiSysExData.evt.size++] = 127 - value;
            
            midiSysExData.evt.midi_message[midiSysExData.evt.size++] = 0x03;
            midiSysExData.evt.midi_message[midiSysExData.evt.size++] = 0x3a;
            midiSysExData.evt.midi_message[midiSysExData.evt.size++] = value;
            midiSysExData.evt.midi_message[midiSysExData.evt.size++] = 127 - value;
            midiSysExData.evt.midi_message[midiSysExData.evt.size++] = 127 - value;
            
            midiSysExData.evt.midi_message[midiSysExData.evt.size++] = 0x03;
            midiSysExData.evt.midi_message[midiSysExData.evt.size++] = 0x34;
            midiSysExData.evt.midi_message[midiSysExData.evt.size++] = 127 - value;
            midiSysExData.evt.midi_message[midiSysExData.evt.size++] = 127 - value;
            midiSysExData.evt.midi_message[midiSysExData.evt.size++] = 127 - value;
            ...
            midiSysExData.evt.midi_message[midiSysExData.evt.size++] = 0x03;
            midiSysExData.evt.midi_message[midiSysExData.evt.size++] = 0x1c;
            midiSysExData.evt.midi_message[midiSysExData.evt.size++] = value;
            midiSysExData.evt.midi_message[midiSysExData.evt.size++] = 0x00;
            midiSysExData.evt.midi_message[midiSysExData.evt.size++] = 0x00;
            ...
            midiSysExData.evt.midi_message[midiSysExData.evt.size++] = 0x03;
            midiSysExData.evt.midi_message[midiSysExData.evt.size++] = 0x1a;
            midiSysExData.evt.midi_message[midiSysExData.evt.size++] = 0x00;
            midiSysExData.evt.midi_message[midiSysExData.evt.size++] = 0x00;
            midiSysExData.evt.midi_message[midiSysExData.evt.size++] = value;
            
            midiSysExData.evt.midi_message[midiSysExData.evt.size++] = 0x03;
            midiSysExData.evt.midi_message[midiSysExData.evt.size++] = 0x18;
            midiSysExData.evt.midi_message[midiSysExData.evt.size++] = value;
            midiSysExData.evt.midi_message[midiSysExData.evt.size++] = value;
            midiSysExData.evt.midi_message[midiSysExData.evt.size++] = 127 - value;
            
            midiSysExData.evt.midi_message[midiSysExData.evt.size++] = 0x03;
            midiSysExData.evt.midi_message[midiSysExData.evt.size++] = 0x19;
            midiSysExData.evt.midi_message[midiSysExData.evt.size++] = 127 - value;
            midiSysExData.evt.midi_message[midiSysExData.evt.size++] = 127 - value;
            midiSysExData.evt.midi_message[midiSysExData.evt.size++] = value;
            ...
            midiSysExData.evt.midi_message[midiSysExData.evt.size++] = 0x03;
            midiSysExData.evt.midi_message[midiSysExData.evt.size++] = 0x24;
            midiSysExData.evt.midi_message[midiSysExData.evt.size++] = 127 - value;
            midiSysExData.evt.midi_message[midiSysExData.evt.size++] = value;
            midiSysExData.evt.midi_message[midiSysExData.evt.size++] = value;
            ...
            midiSysExData.evt.midi_message[midiSysExData.evt.size++] = 0x03;
            midiSysExData.evt.midi_message[midiSysExData.evt.size++] = 0x25;
            midiSysExData.evt.midi_message[midiSysExData.evt.size++] = value;
            midiSysExData.evt.midi_message[midiSysExData.evt.size++] = 127 - value;
            midiSysExData.evt.midi_message[midiSysExData.evt.size++] = value;
            
            midiSysExData.evt.midi_message[midiSysExData.evt.size++] = 0x03;
            midiSysExData.evt.midi_message[midiSysExData.evt.size++] = 0x1f;
            midiSysExData.evt.midi_message[midiSysExData.evt.size++] = 127 - value;
            midiSysExData.evt.midi_message[midiSysExData.evt.size++] = 0x00;
            midiSysExData.evt.midi_message[midiSysExData.evt.size++] = value;
            ...
            midiSysExData.evt.midi_message[midiSysExData.evt.size++] = 0x03;
            midiSysExData.evt.midi_message[midiSysExData.evt.size++] = 0x23;
            midiSysExData.evt.midi_message[midiSysExData.evt.size++] = value;
            midiSysExData.evt.midi_message[midiSysExData.evt.size++] = 127 - value;
            midiSysExData.evt.midi_message[midiSysExData.evt.size++] = value;
            
            midiSysExData.evt.midi_message[midiSysExData.evt.size++] = 0x03;
            midiSysExData.evt.midi_message[midiSysExData.evt.size++] = 0x26;
            midiSysExData.evt.midi_message[midiSysExData.evt.size++] = 127 - value;
            midiSysExData.evt.midi_message[midiSysExData.evt.size++] = 127 - value;
            midiSysExData.evt.midi_message[midiSysExData.evt.size++] = 127 - value;
            ...
            midiSysExData.evt.midi_message[midiSysExData.evt.size++] = 0x03;
            midiSysExData.evt.midi_message[midiSysExData.evt.size++] = 0x2d;
            midiSysExData.evt.midi_message[midiSysExData.evt.size++] = value;
            midiSysExData.evt.midi_message[midiSysExData.evt.size++] = 0x00;
            midiSysExData.evt.midi_message[midiSysExData.evt.size++] = 0x00;
            
            midiSysExData.evt.midi_message[midiSysExData.evt.size++] = 0x03;
            midiSysExData.evt.midi_message[midiSysExData.evt.size++] = 0x2f;
            midiSysExData.evt.midi_message[midiSysExData.evt.size++] = 127 - value;
            midiSysExData.evt.midi_message[midiSysExData.evt.size++] = value;
            midiSysExData.evt.midi_message[midiSysExData.evt.size++] = value;
            
            midiSysExData.evt.midi_message[midiSysExData.evt.size++] = 0x03;
            midiSysExData.evt.midi_message[midiSysExData.evt.size++] = 0x2e;
            midiSysExData.evt.midi_message[midiSysExData.evt.size++] = 0x00;
            midiSysExData.evt.midi_message[midiSysExData.evt.size++] = value;
            midiSysExData.evt.midi_message[midiSysExData.evt.size++] = 0x00;
            ...
            midiSysExData.evt.midi_message[midiSysExData.evt.size++] = 0x03;
            midiSysExData.evt.midi_message[midiSysExData.evt.size++] = 0x2b;
            midiSysExData.evt.midi_message[midiSysExData.evt.size++] = 0x00;
            midiSysExData.evt.midi_message[midiSysExData.evt.size++] = 0x00;
            midiSysExData.evt.midi_message[midiSysExData.evt.size++] = value;
            ...
            midiSysExData.evt.midi_message[midiSysExData.evt.size++] = 0x03;
            midiSysExData.evt.midi_message[midiSysExData.evt.size++] = 0x2a;
            midiSysExData.evt.midi_message[midiSysExData.evt.size++] = 127 - value;
            midiSysExData.evt.midi_message[midiSysExData.evt.size++] = 127 - value;
            midiSysExData.evt.midi_message[midiSysExData.evt.size++] = 127 - value;
            ...
            midiSysExData.evt.midi_message[midiSysExData.evt.size++] = 0x03;
            midiSysExData.evt.midi_message[midiSysExData.evt.size++] = 0x0b;
            midiSysExData.evt.midi_message[midiSysExData.evt.size++] = value;
            midiSysExData.evt.midi_message[midiSysExData.evt.size++] = 0x00;
            midiSysExData.evt.midi_message[midiSysExData.evt.size++] = 0x00;
            
            midiSysExData.evt.midi_message[midiSysExData.evt.size++] = 0x03;
            midiSysExData.evt.midi_message[midiSysExData.evt.size++] = 0x0c;
            midiSysExData.evt.midi_message[midiSysExData.evt.size++] = 127 - value;
            midiSysExData.evt.midi_message[midiSysExData.evt.size++] = value;
            midiSysExData.evt.midi_message[midiSysExData.evt.size++] = value;
            ...
            midiSysExData.evt.midi_message[midiSysExData.evt.size++] = 0x03;
            midiSysExData.evt.midi_message[midiSysExData.evt.size++] = 0x0e;
            midiSysExData.evt.midi_message[midiSysExData.evt.size++] = value;
            midiSysExData.evt.midi_message[midiSysExData.evt.size++] = 127 - value;
            midiSysExData.evt.midi_message[midiSysExData.evt.size++] = value;
            
            midiSysExData.evt.midi_message[midiSysExData.evt.size++] = 0x03;
            midiSysExData.evt.midi_message[midiSysExData.evt.size++] = 0x0f;
            midiSysExData.evt.midi_message[midiSysExData.evt.size++] = 0x7f;
            midiSysExData.evt.midi_message[midiSysExData.evt.size++] = 0x00;
            midiSysExData.evt.midi_message[midiSysExData.evt.size++] = value;
            
            midiSysExData.evt.midi_message[midiSysExData.evt.size++] = 0x03;
            midiSysExData.evt.midi_message[midiSysExData.evt.size++] = 0x10;
            midiSysExData.evt.midi_message[midiSysExData.evt.size++] = value;
            midiSysExData.evt.midi_message[midiSysExData.evt.size++] = value;
            midiSysExData.evt.midi_message[midiSysExData.evt.size++] = 127 - value;

            midiSysExData.evt.midi_message[midiSysExData.evt.size++] = 0x03;
            midiSysExData.evt.midi_message[midiSysExData.evt.size++] = 0x11;
            midiSysExData.evt.midi_message[midiSysExData.evt.size++] = value;
            midiSysExData.evt.midi_message[midiSysExData.evt.size++] = value;
            midiSysExData.evt.midi_message[midiSysExData.evt.size++] = value;
