...
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
class PressWithResendOnRelease_Midi_Widget : public Midi_Widget
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
{
public:
    PressWithResendOnRelease_Midi_Widget(Midi_RealSurface* surface, string role, string name, bool wantsFeedback, MIDI_event_ex_t* press, MIDI_event_ex_t* release) : Midi_Widget(surface, role, name, press, release)
    {
    ...
    virtual void ProcessMidiMessage(const MIDI_event_ex_t* midiMessage) override
    {
        ...
        if(midiPressMessage_->IsEqualTo(midiMessage))
            ...
            SendMidiMessage(midiReleaseMessage_);
    }
};

/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
class PressReleaseWithResendOnRelease_Midi_Widget : public Midi_Widget
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
{
public:
    PressReleaseWithResendOnRelease_Midi_Widget(Midi_RealSurface* surface, string role, string name, bool wantsFeedback, MIDI_event_ex_t* press, MIDI_event_ex_t* release) : Midi_Widget(surface, role, name, press, release)
    {
        surface->AddWidgetToMessageMap(to_string(midiPressMessage_->midi_message[0]) + to_string(midiPressMessage_->midi_message[1]) + to_string(midiPressMessage_->midi_message[2]), this);
    }
    ...
    virtual void ProcessMidiMessage(const MIDI_event_ex_t* midiMessage) override
    {
        ...
        if(midiReleaseMessage_->IsEqualTo(midiMessage))
            SendMidiMessage(midiReleaseMessage_);
    }
};

// End Special for X Touch compact
