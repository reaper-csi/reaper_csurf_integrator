...
public:
    ...
    MidiCSurf(CSurfManager* manager, LogicalSurface* logicalSurface, const string name, const int numSurfaceChannels, midi_Input* midiInput, midi_Output* midiOutput, bool midiInMonitor, bool midiOutMonitor)
    : RealCSurf(manager, logicalSurface, name, numSurfaceChannels), midiInput_(midiInput), midiOutput_(midiOutput), midiInMonitor_(midiInMonitor), midiOutMonitor_(midiOutMonitor) {}
