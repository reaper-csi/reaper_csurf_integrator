...
public:
    ...
    virtual void RequestUpdate(string widgetGUID, string commandString) override
    {
        manager->SetWidgetValue(widgetGUID, DAW::GetToggleCommandState(CommandId(commandString)));
    }
    
    virtual void Do(string commandString) override
    {
...
public:
    ...
    virtual void RequestUpdate(string widgetGUID, MediaTrack* track, int fxIndex, int paramIndex) override
    {
        double min, max = 0;
