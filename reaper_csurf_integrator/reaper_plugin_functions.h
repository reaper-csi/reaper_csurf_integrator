...
// Generated by REAPER v6.16rc5/OSX64
...
REAPERAPI_DEF //==============================================
// EnumerateFiles
// List the files in the "path" directory. Returns NULL/nil when all files have been listed. See EnumerateSubdirectories
...
// List the subdirectories in the "path" directory. Returns NULL/nil when all subdirectories have been listed. See EnumerateFiles
...
REAPERAPI_DEF //==============================================
// PlayPreviewEx
// return nonzero on success. bufflags&1 = buffer source, &2=treat length changes in source as varispeed and adjust internal state accordingly if buffering.
